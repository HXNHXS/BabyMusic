...
-(void)dataInit{
    NSArray * arr=@[@[@"使用宝宝天天听是完成免费得，在线使用时产生的流量费用由当地运营收取，资费标准请资讯当地运营商"],@[@"锁屏后是可以继续收听宝宝天天听的"],@[@"为了节省流量建议您下载后收听，我们默认把个人>仅WIFI网络下载功能开启，保证您只在WIFI网络下才使用下载功能"],@[@"可以在播放界面，点击定时关闭图标设置关闭的时间"],@[@"使用定时播放时,要在播放界面进行播放或者暂停！首页不要点击播放或者暂停按钮,不然定时播放会失效.如果失效,请在播放界面再次点击播放或者暂停按钮即可"],@[@"进入我的>点击清理缓存"],@[@"请联系QQ245874336"]];
    self.dataArr=[[NSMutableArray alloc] initWithArray:arr];
    _headArr=@[@"1、宝宝天天听是否收费？",@"2、锁屏后宝宝天天听还会自动播放内容吗？",@"3、使用宝宝天天听客户端是，怎么节省流量？",@"4、可以定时关闭播放吗？",@"5、定时播放怎么不管用？",@"6、怎样清理缓存呢？",@"7、如果在这里没有我想要的答案怎么办？"];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    UILabel * label=[[UILabel alloc] initWithFrame:CGRectMake(0, 0, kSreenSize.width, 20)];
