...
@interface AlbumViewController ()<UITableViewDataSource,UITableViewDelegate,UMSocialUIDelegate>
{
...
-(void)jumpListenController{
    if (self.pushArr.count){
        ...
        MediaListModel * model=self.model;
        BadyTabBarViewController * tabber=(BadyTabBarViewController *)self.navigationController.tabBarController;
